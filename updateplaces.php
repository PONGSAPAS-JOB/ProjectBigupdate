    ...
    <div class="container">
        ...
        <form method="post">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="name_places" name="name_places" 
                        value="<?php echo $row['name_places']; ?>" 
                        aria-describedby="ชื่อสถานที่" required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="contact_places" name="contact_places"
                        value="<?php echo $row['contact_places']; ?>" 
                        aria-describedby="ข้อมูลติดต่อ สถานที่" required>  
            </div>
